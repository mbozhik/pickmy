...
function TableFooter({className, ...props}: React.ComponentProps<'tfoot'>) {
  return <tfoot data-slot="table-footer" className={cn('bg-neutral-100 border-t border-neutral-200 font-medium [&>tr]:last:border-b-0', className)} {...props} />
}

function TableRow({className, ...props}: React.ComponentProps<'tr'>) {
  return <tr data-slot="table-row" className={cn('hover:bg-neutral-100 data-[state=selected]:bg-neutral-100 border-b border-neutral-200 transition-colors', className)} {...props} />
}
...
function TableCaption({className, ...props}: React.ComponentProps<'caption'>) {
  return <caption data-slot="table-caption" className={cn('text-neutral-600 mt-4 text-sm', className)} {...props} />
}
